...
Why: Supabase requires the redirect URL used by `signInWithOtp` to match the Auth redirect allowlist. Supabase recommends exact production URLs and allows localhost for development.
