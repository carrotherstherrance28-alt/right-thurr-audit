...
Discord node was added to the active n8n workflow as a non-blocking `#leads-alerts` alert branch.
Live Discord QA test returned a successful n8n execution with `Discord: Leads Alert` included.
```
